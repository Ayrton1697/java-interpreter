...
void initVM(){
    ...
    defineNative("clock", clockNative, 0); // last param is arity
}
...
static bool callValue(Value callee, int argCount){
    if(IS_OBJ(callee)){
        ...
        case OBJ_NATIVE:
            ...
            if (argCount != ((ObjNative*)AS_OBJ(callee))->arity){
                runtimeError("Expected %d arguments but got %d.", ((ObjNative*)AS_OBJ(callee))->arity, argCount);
                return false;
            }
